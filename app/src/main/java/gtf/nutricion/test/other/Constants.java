...
public class Constants {
    ...
    public static double BODY_WEIGHT = 0.0;
    public static double SIZE = 0.0;

    public static double IMC = 0.0;
    public static double PLIEGUE_CUTANEO_TRICIPITAL = 0.0;
    public static double CIRCUNFERENCIA_MUSCULAR_BRAZO = 0.0;
    public static double CIRCUNFERENCIA_CINTURA = 0.0;
    public static double HEMOGOBLINA = 0.0;
